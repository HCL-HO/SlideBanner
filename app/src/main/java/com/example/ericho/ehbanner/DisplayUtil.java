...
public class DisplayUtil {
    ...
    public static int getDpFromRes(Context context, int pk10_num_result_size) {
        int dp = (int) (context.getResources().getDimension(pk10_num_result_size) / context.getResources().getDisplayMetrics().density);
        return dp;
    }
}
